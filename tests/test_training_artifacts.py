...
def test_training_outputs_exist_and_are_non_empty():
    required_outputs = [
        ...
        VALIDATION_DIR / "calibrated_metrics.json",
        VALIDATION_DIR / "split_summary.json",
        VALIDATION_DIR / "provenance.json",
        VALIDATION_DIR / "artifact_checksums.json",
        VALIDATION_DIR / "feature_policy_summary.json",
        VALIDATION_DIR / "segment_stability.json",
        VALIDATION_DIR / "segment_stability.md",
